...
st.markdown(
    ...
    <br>
    <h6 style="display:inline;">Model Evaluation:</h6> If the model identifies a positive case, it is correct **43% of the time** (precision), meaning it will give a false alarm 57% of the time. 
    <br>
    <h6 style="display:inline;">Model Deployment:</h6> After several iterations, the project culminated in deployment on **Google Cloud Platform** with a Streamlit frontend. For comprehensive code, versioning, and visualizations, please visit the [Technical Summary](https://fake-heart-attack.streamlit.app/Technical_summary) on this website.
